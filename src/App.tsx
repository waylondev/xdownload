...
import { Music, Film, FileText, ChevronLeft, ChevronRight, Github, Zap, Database, Settings, Info, Download } from 'lucide-react';
        ...
        <nav className="flex-1 p-2 space-y-1 overflow-y-auto scrollbar-hide">
          ...
          <button
            onClick={() => {
              ...
              handleTypeChange('music');
            }}
            className={`flex items-center justify-center gap-2 w-full p-2 rounded-lg transition-all duration-300 ${sidebarCollapsed ? 'justify-center' : 'justify-start'} ${activeView === 'search' && activeType === 'music' ? 'bg-blue-600/20 text-blue-400' : 'hover:bg-slate-800'}`}
          >
            <div className={`w-10 h-10 rounded-lg flex items-center justify-center transition-all duration-300 ${activeView === 'search' && activeType === 'music' ? 'bg-blue-600/30 text-blue-400' : 'bg-slate-800 text-slate-400 hover:bg-slate-700 hover:text-blue-300'}`}>
          ...
          <button
            ...
            className={`flex items-center justify-center gap-2 w-full p-2 rounded-lg transition-all duration-300 ${sidebarCollapsed ? 'justify-center' : 'justify-start'} ${activeView === 'search' && activeType === 'video' ? 'bg-blue-600/20 text-blue-400' : 'hover:bg-slate-800'}`}
          >
            <div className={`w-10 h-10 rounded-lg flex items-center justify-center transition-all duration-300 ${activeView === 'search' && activeType === 'video' ? 'bg-blue-600/30 text-blue-400' : 'bg-slate-800 text-slate-400 hover:bg-slate-700 hover:text-blue-300'}`}>
          ...
          <button
            ...
            className={`flex items-center justify-center gap-2 w-full p-2 rounded-lg transition-all duration-300 ${sidebarCollapsed ? 'justify-center' : 'justify-start'} ${activeView === 'search' && activeType === 'file' ? 'bg-blue-600/20 text-blue-400' : 'hover:bg-slate-800'}`}
          >
            <div className={`w-10 h-10 rounded-lg flex items-center justify-center transition-all duration-300 ${activeView === 'search' && activeType === 'file' ? 'bg-blue-600/30 text-blue-400' : 'bg-slate-800 text-slate-400 hover:bg-slate-700 hover:text-blue-300'}`}>
          ...
          <button
            ...
            className={`flex items-center justify-center gap-2 w-full p-2 rounded-lg transition-all duration-300 ${sidebarCollapsed ? 'justify-center' : 'justify-start'} ${activeView === 'download' ? 'bg-blue-600/20 text-blue-400' : 'hover:bg-slate-800'}`}
          >
            <div className={`w-10 h-10 rounded-lg flex items-center justify-center transition-all duration-300 ${activeView === 'download' ? 'bg-blue-600/30 text-blue-400' : 'bg-slate-800 text-slate-400 hover:bg-slate-700 hover:text-blue-300'}`}>
          ...
          {/* 数据 */}
          <button
            onClick={() => handleNotImplemented('数据')}
            className={`flex items-center justify-center gap-2 w-full p-2 rounded-lg transition-all duration-300 ${sidebarCollapsed ? 'justify-center' : 'justify-start'} hover:bg-slate-800 sidebar-tooltip`}
            data-tooltip="数据功能正在开发中"
          >
          ...
          {/* 设置 */}
          <button
            onClick={() => handleNotImplemented('设置')}
            className={`flex items-center justify-center gap-2 w-full p-2 rounded-lg transition-all duration-300 ${sidebarCollapsed ? 'justify-center' : 'justify-start'} hover:bg-slate-800 sidebar-tooltip`}
            data-tooltip="设置功能正在开发中"
          >
            <div className="w-10 h-10 rounded-lg flex items-center justify-center transition-all duration-300 bg-slate-800 text-slate-400 hover:bg-slate-700 hover:text-blue-300">
          ...
          {/* 关于 */}
          <button
            onClick={() => handleNotImplemented('关于')}
            className={`flex items-center justify-center gap-2 w-full p-2 rounded-lg transition-all duration-300 ${sidebarCollapsed ? 'justify-center' : 'justify-start'} hover:bg-slate-800 sidebar-tooltip`}
            data-tooltip="关于功能正在开发中"
          >
            <div className="w-10 h-10 rounded-lg flex items-center justify-center transition-all duration-300 bg-slate-800 text-slate-400 hover:bg-slate-700 hover:text-blue-300">
        ...
        <div className="container mx-auto p-4 sm:p-6 space-y-6">
          ...
          {activeView === 'search' && (
            <>
              ...
              {/* 搜索区域 */}
              <div className="bg-slate-900/50 backdrop-blur-md p-4 sm:p-5 rounded-2xl border border-slate-800 shadow-xl">
                <SearchBar
