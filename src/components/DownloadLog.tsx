  ...
  return (
    <div className="bg-gray-900 border border-gray-700 rounded-lg overflow-hidden">
      <div className="px-3 sm:px-4 py-2 bg-gray-800 border-b border-gray-700 flex items-center justify-between">
        <span className="text-xs sm:text-sm font-medium text-gray-300">Download Log</span>
        <button
          onClick={onClearOutput}
          className="px-2 sm:px-3 py-1 bg-gray-700 hover:bg-gray-600 rounded text-xs transition-colors flex items-center gap-1"
        >
      ...
      <div className="h-64 lg:h-80 overflow-y-auto p-3 sm:p-4 font-mono text-xs sm:text-sm">
        {output.length === 0 ? (
